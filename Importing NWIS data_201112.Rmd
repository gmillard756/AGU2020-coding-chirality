...
df12 = nwis.get_record( sites=site,  start='2011-05-16', end='2019-10-08', service='qwdata')

df14 = nwis.get_data( sites=site, start='2011-05-16', end='2019-10-08', service='dv')
...
df12 <- NWIS$get_qwdata(datetime_index = T, site_no=py$site[1], parameterCd=want[1])
NWIS$get_record(sites = py$site[1], service = 'qwdata')
want2 <- c(681, 945, 50287, 50285)
df12a <- df12[df12$parm_cd %in% want2,]
df12a[df12a$parm_cd==50287,]
```
